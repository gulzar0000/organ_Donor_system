  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <?php
        ...
        $offset = ($page - 1) * $limit;
        $count=$offset+1;
        $sql= "select * from donor_details join organ where donor_details.donor_organ=organ.organ_id LIMIT {$offset},{$limit}";
      ...
      <table class="table table-bordered" style="text-align:center">
          ...
          <th style="text-align:center">donate organ</th>
          ...
          <tr>
                  ...
                  <td><?php echo $row['donor_gender']; ?></td>
                    <td><?php echo $row['organ_group']; ?></td>

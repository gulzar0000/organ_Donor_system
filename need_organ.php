...
<body>
  ...
  <form name="needorgan" action="" method="post">
  <div class="row">
  <div class="col-lg-4 mb-4">
  <div class="font-italic">organ Group<span style="color:red">*</span></div>
...
<div class="col-lg-4 mb-4">
<div class="font-italic">Reason, why do you need organ?<span style="color:red">*</span></div>
...
<?php if(isset($_POST['search'])){
  ...
  $bg=$_POST['organ'];
  $sql= "select * from donor_details join organ where donor_details.donor_organ=organ.organ_id AND donor_organ='{$bg}' order by rand() limit 5";
  $result=mysqli_query($conn,$sql) or die("query unsuccessful.");
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      <div class="card" style="width:300px">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              <b>donate organ : </b> <b><?php echo $row['donate_organ']; ?></b><br>
  ...
  <?php
    ...
    else
    {
        ...
        echo '<div class="alert alert-danger">No Donor Found For your search organ group </div>';

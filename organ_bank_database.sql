...
create table organ(
organ_id int auto_increment Not Null,
organ_name varchar(10) NOT NULL,
primary key(organ_id)
);

/* insert all blood groups*/
insert into organ(organ_group)
values("heart"),("liver"),("kidney"),("eye"),("lungs"),("tissue"),("brain"),("bone");
...
INSERT INTO pages (page_id, page_name, page_type, page_data) VALUES
(4, 'The Need For organ', 'needfororgan', '<span style="color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; text-align: justify;">There are many reasons patients need blood. A common misunderstanding about blood usage is that accident victims are the patients who use the most blood. Actually, people needing the most blood include those:
1) 5 lakh people die because of non-availability of organs.2) 2 lakh people die of liver disease.3) 5 lakh people die from heart disease.4) 1 lakh 50 thousands people await a kidney transplant.5) 10 lakh peope suffer from corneal blindness.</span>');

INSERT INTO pages (page_id, page_name, page_type, page_data) VALUES
(5, 'organ donationn Tips', 'organdonationtips', '<span style="color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; text-align: justify;">

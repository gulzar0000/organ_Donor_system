...
$sql= "select * from donor_details where donor_organ='{$bg}' order by rand() limit 5";
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    <div class="card" style="width:300px">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            <b>donate organ : </b> <b><?php echo $row['donor_group']; ?></b><br>
...
<?php
  ...
  else
  {
      ...
      echo '<div class="alert alert-danger">No Donor Found For your search organ</div>';
